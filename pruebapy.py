...
modelo_seleccionado = st.sidebar.selectbox("Elegí un modelo de Groq", options=list(MODELOS.keys()))
...
if not api_key:
    st.error("⚠️ No se encontró la API Key. Creá un archivo .env con GROQ_API_KEY='tu_clave_aquí'")
else:
